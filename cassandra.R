## To install acnd check the status of Cassandra
## https://medium.com/@abwahed23/install-cassandra-on-aws-ec2-linux-instance-303de63e0f82
## https://gist.github.com/sbuljat/7f76cc2f7ff44c34e63cbfe47f21311f

library(RCassandra)

connect.handle <- RC.connect(host="ec2-3-142-239-208.us-east-2.compute.amazonaws.com", port=9042)
#RC.cluster.name(connect.handle)
### https://www.r-bloggers.com/2018/12/using-cassandra-through-r/
